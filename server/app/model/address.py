...
class Address(db.Model):
    ...
    address_line1 = db.Column("address_line1", db.String(240), nullable=False)
    address_line2 = db.Column("address_line2", db.String(320), nullable=False)
    district = db.Column("district", db.String(80), nullable=False)
